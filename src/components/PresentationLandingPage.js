...
import VerticalFlipCardsDeck from './VerticalFlipCardsDeck';
...
export default function PresentationLandingPage({
  ...
  return (
    ...
    >
      ...
      {/* =========================================================================
          3. 3D VERTICAL FLIP CARDS DECK (5 Cards flip vertically on scroll to reveal next)
          ========================================================================= */}
      <section id="interactive-showcase" className="min-h-screen flex flex-col justify-center items-center py-12 relative z-10">
        <VerticalFlipCardsDeck />
      </section>
